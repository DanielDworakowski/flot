...
class Config(DefaultConfig):
    ...
    modelLoadPath = '/home/jiwon/mixed-fixedData_model_best.pth.tar'
    modelLoadPath = '/home/jiwon/rl_normalized-fixeddata_model_best.pth.tar'
    modelLoadPath = '/home/jiwon/rl_multiconv-2t-fix_model_best.pth.tar'
    #modelLoadPath = '/home/jiwon/data/model/model_best.pth.tar'
    # modelLoadPath = '/disk1/model/model_best.pth.tar'
    #modelLoadPath = '/disk1/model/rl_multiconv-2t-normalized_model_best.pth.tar'
    #modelLoadPath = '/disk1/model/rl_normalized-rnet34_model_best.pth.tar'
    modelLoadPath = '/disk1/model/rl_multiconv-2t-normalized_model_best.pth.tar'
    modelLoadPath = '/home/tommy/code/vbp/rl_moremoremorenewData_model_best.pth.tar'
