...
class Rescale(object):
    ...
    def __call__(self, sample):
        ...
        return {'img': img, 'labels': labels, 'glboalIdx': sample['globalIdx']}
...
class RandomCrop(object):
    ...
    def __call__(self, sample):
        ...
        return {'img': image, 'labels': labels, 'glboalIdx': sample['globalIndex']}
...
class ToTensor(object):
    ...
    def __call__(self, sample):
        ...
        return {'img': self.toTensor(image[:,:,0:3]),
                'labels': torch.from_numpy(labels), 'glboalIdx': sample['globalIdx']}
